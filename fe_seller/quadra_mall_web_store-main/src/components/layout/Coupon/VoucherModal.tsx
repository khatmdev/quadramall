// // components/layout/Coupon/DiscountManagement.tsx
...
//   // Lấy storeId từ localStorage hoặc auth state
...
//     };
//   }, [filters.search, dispatch, currentStoreId, currentPage, pageSize]);
...
//     if (!isActive) return 'text-yellow-600 bg-yellow-100';
//     if (now < start) return 'text-blue-600 bg-blue-100';
//     if (now > end) return 'text-red-600 bg-red-100';
...
//   const getStatusIcon = (isActive: boolean, startDate: string, endDate: string) => {
//     const now = new Date();
//     const start = new Date(startDate);
//     const end = new Date(endDate);
    
//     if (!isActive) return <AlertCircle size={16} />;
//     if (now < start) return <AlertCircle size={16} />;
//     if (now > end) return <XCircle size={16} />;
...
//             <p className="text-gray-600 mb-4">Tạo mã giảm giá đầu tiên để thu hút khách hàng</p>
//             <button
//               onClick={handleCreateDiscount}
...
//                           <Calendar size={14} />
//                           <div>
//                             <div className="font-medium">{formatDate(discount.startDate)}</div>
//                             <div className="text-xs text-gray-500">đến {formatDate(discount.endDate)}</div>
//                           </div>
//                         </div>
//                       </td>
//                       <td className="px-6 py-4">
...
//                           getStatusColor(discount.isActive, discount.startDate, discount.endDate)
//                         }`}>
//                           {getStatusIcon(discount.isActive, discount.startDate, discount.endDate)}
//                           {getStatusText(discount.isActive, discount.startDate, discount.endDate)}
//                         </div>
//                       </td>
//                       <td className="px-6 py-4">
//                         <div className="flex items-center gap-2">
